...
/**
 *Questo programma tramite l'utilizzo dei thread distingue i numeri pari dai numeri dispari
 * per poi stamparli
...
public class PariDispari extends Thread{
  ...
  private int ritardo = 500;
   ...
   /**
   * @param finale è il numero di volte in cui viene effettuato un output
